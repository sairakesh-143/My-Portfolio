      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="w-9 h-9 rounded-xl bg-white/[0.04] hover:bg-amber-500 hover:text-black border border-white/[0.08] flex items-center justify-center text-slate-300 transition-all cursor-pointer"
