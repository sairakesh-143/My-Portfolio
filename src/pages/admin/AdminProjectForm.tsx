  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!serviceId || serviceId === "YOUR_SERVICE_ID") {
      ...
      toast({
        ...
        description: "EmailJS Service ID is missing.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (!templateId || templateId === "YOUR_TEMPLATE_ID") {
      ...
      toast({
        title: "Email configuration error",
        description: "EmailJS Template ID is missing.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (!publicKey || publicKey === "YOUR_PUBLIC_KEY") {
      ...
      toast({
        title: "Email configuration error",
        description: "EmailJS Public Key is missing.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const subject =
        formData.subject.trim() || "Portfolio Contact Inquiry";

      /*
       * Send email FIRST.
       *
       * EmailJS Template:
       * To Email = dwarampudirakesh143@gmail.com
       * Reply To = {{email}}
       */
      await emailjs.send(
        serviceId,
        templateId,
        {
          ...
          // This is available if your EmailJS template uses {{to_email}}
          to_email: toEmail || "dwarampudirakesh143@gmail.com",
        },
        {
          publicKey,
        }
      ...
      /*
       * Save to Admin Inbox ONLY after email succeeds.
       */
      ...
      toast({
        ...
        description:
          "Your message has been sent to dwarampudirakes@gmail.com",
      });
      ...
      console.error("Public Key exists:", Boolean(publicKey));
      console.error("===================================");
      ...
      toast({
        ...
        description:
          error?.text ||
          "Unable to send the email. Please check your EmailJS configuration.",
        variant: "destructive",
      });
    }
  };
